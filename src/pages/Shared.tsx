...
export function Shared() {
  ...
  return (
    <div className="p-4 sm:p-8 max-w-7xl mx-auto space-y-10" onClick={() => { setActiveMenu(null); if (!isSelectionActive) clearSelection(); }}>
      ...
      <div className="rounded-2xl border border-amber-200 bg-amber-50 px-5 py-4 text-sm font-semibold leading-6 text-amber-800 shadow-sm dark:border-amber-500/20 dark:bg-amber-500/10 dark:text-amber-100">
        This feature is not available right now. It is being tested and will arrive after the stable release.
      </div>
